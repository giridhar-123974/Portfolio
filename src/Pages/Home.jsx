...
const TECH_STACK = ["Python", "FastAPI", "React", "Node.js", "MongoDB"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/giridhar-123974" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/giridharnaikbukke/" },
  { icon: Mail, link: "mailto:bukkegiridharnaik@gmail.com" },
];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen gap-8 lg:gap-12">
            ...
            >
              ...
              >
                ...
                <a href="https://docs.google.com/document/d/1ongf4imTxwYYDIbSvQOTOKkc5aBmfXez/edit?usp=drive_link&ouid=108382056500703121054&rtpof=true&sd=true" target="_blank" rel="noopener noreferrer">
                  <button className="group relative w-[160px]">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-[#4f52c9] to-[#8644c5] rounded-xl opacity-50 blur-md group-hover:opacity-90 transition-all duration-700"></div>
                    <div className="relative h-11 bg-[#030014] backdrop-blur-xl rounded-lg border border-white/10 leading-none overflow-hidden">
                      <div className="absolute inset-0 scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500 bg-gradient-to-r from-[#4f52c9]/20 to-[#8644c5]/20"></div>
                      <span className="absolute inset-0 flex items-center justify-center gap-2 text-sm group-hover:gap-3 transition-all duration-300">
                        ...
                        <FileText className="w-4 h-4 text-gray-200 group-hover:scale-110 transform transition-all duration-300 z-10" />
                      </span>
                    </div>
                  </button>
                </a>
              ...
              <div className="relative w-full h-full opacity-90">
                ...
                >
                  <DotLottieReact
                    ...
                    className={`w-full h-full transition-all duration-500 ${isHovering ? "scale-[120%] rotate-2" : "scale-[115%]"
                      }`}
                  />
                </div>
                ...
                >
                  <div
                    className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-gradient-to-br from-indigo-500/10 to-purple-500/10 blur-3xl animate-pulse transition-all duration-700 ${isHovering ? "scale-110" : "scale-100"
                      }`}
                  ></div>
                </div>
              </div>
